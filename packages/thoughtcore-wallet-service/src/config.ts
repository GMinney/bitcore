...
const Config = (): any => {
  let defaultConfig = {
    ...
    blockchainExplorerOpts: {
      ...
      xrp: {
        livenet: {
          url: 'https://api-xrp.thoughtcore.io'
        },
        testnet: {
          url: 'https://api-xrp.thoughtcore.io'
        }
      ...
      matic: {
        livenet: {
          url: 'https://api-matic.thoughtcore.io'
        },
        amoy: {
          url: 'https://api-matic.thoughtcore.io'
        }
    ...
    // banxa : {
    //   sandbox: {
    //     api: 'https://thoughtnetwork.banxa-sandbox.com/api',
    ...
    //     api: 'https://sandbox.test-simplexcc.com',
    //     appProviderId: 'thoughtnetworkwidget'
    //   },
    //   productionWeb: {
    ...
    //  from: 'wallet-service@thoughtcore.io',
    //  // Note: Prod templates are in a the copay-emails repo (https://github.com/thoughtnetwork/copay-emails)
    //  templatePath: 'templates',
    //  defaultLanguage: 'en',
    //  defaultUnit: 'tht',
    //  publicTxUrlTemplate: {
    //   tht: {
    //     livenet: 'https://thoughtnetwork.com/insight/#/THT/mainnet/tx/{{txid}}',
    //     testnet: 'https://thoughtnetwork.com/insight/#/THT/testnet/tx/{{txid}}',
    //   },
    //   bch: {
    //     livenet: 'https://thoughtnetwork.com/insight/#/BCH/mainnet/tx/{{txid}}',
    //     testnet: 'https://thoughtnetwork.com/insight/#/BCH/testnet/tx/{{txid}}',
    //   },
    //   eth: {
    ...
    //  },
    //   ltc: {
    //     livenet: 'https://thoughtnetwork.com/insight/#/LTC/mainnet/tx/{{txid}}',
    //     testnet: 'https://thoughtnetwork.com/insight/#/LTC/testnet/tx/{{txid}}',
    //  }
    // },
    // },
    // To use sendgrid:
