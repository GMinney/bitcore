...
describe('Fiat rate service', function () {
        ...
        function (err) {
          ...
          service.getHistoricalRates(
            ...
            function (err, res) {
              ...
              res['tht'][3].ts.should.equal(100);
              res['tht'][3].rate.should.equal(1.0);

              res['tht'][2].ts.should.equal(200);
              res['tht'][2].rate.should.equal(2.0);

              res['tht'][1].ts.should.equal(300);
              res['tht'][1].rate.should.equal(3.0);

              res['tht'][0].ts.should.equal(400);
              res['tht'][0].rate.should.equal(4.0);
              clock.restore();
              done();
            }
          );
  ...
  describe('#fetch', function () {
    it('should fetch rates from all coins', function (done) {
      ...
      request.get
        .withArgs({
          url: 'https://thoughtnetwork.com/api/rates/THT?p=bws',
          json: true
        })
        .yields(null, null, tht);
      request.get
        .withArgs({
          url: 'https://thoughtnetwork.com/api/rates/BCH?p=bws',
          json: true
        })
        .yields(null, null, bch);
      request.get
        .withArgs({
          url: 'https://thoughtnetwork.com/api/rates/ETH?p=bws',
          json: true
        })
        .yields(null, null, eth);
      request.get
        .withArgs({
          url: 'https://thoughtnetwork.com/api/rates/MATIC?p=bws',
          json: true
        })
        .yields(null, null, matic);
      request.get
        .withArgs({
          url: 'https://thoughtnetwork.com/api/rates/XRP?p=bws',
          json: true
        })
        .yields(null, null, xrp);
      request.get
        .withArgs({
          url: 'https://thoughtnetwork.com/api/rates/DOGE?p=bws',
          json: true
        })
        .yields(null, null, doge);
      request.get
        .withArgs({
          url: 'https://thoughtnetwork.com/api/rates/LTC?p=bws',
          json: true
        })
        .yields(null, null, ltc);
      request.get
        .withArgs({
          url: 'https://thoughtnetwork.com/api/rates/SHIB?p=bws',
          json: true
        })
        .yields(null, null, shib);
      request.get
        .withArgs({
          url: 'https://thoughtnetwork.com/api/rates/APE?p=bws',
          json: true
        })
        .yields(null, null, ape);
      request.get
        .withArgs({
          url: 'https://thoughtnetwork.com/api/rates/WTHT?p=bws',
          json: true
        })
        .yields(null, null, tht);
      request.get
        .withArgs({
          url: 'https://thoughtnetwork.com/api/rates/WETH?p=bws',
          json: true
        })
        .yields(null, null, eth);
