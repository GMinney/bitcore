...
describe('Email notifications', function() {
  ...
  describe('Shared wallet', function() {
          ...
          async.eachSeries(w.copayers, function(copayer, next) {
            ...
            emailService.start({
              ...
              emailOpts: {
                ...
                publicTxUrlTemplate: {
                  tht: {
                    livenet: 'https://insight.thoughtnetwork.com/tx/{{txid}}',
                    testnet: 'https://test-insight.thoughtnetwork.com/tx/{{txid}}',
                  },
                  bch: {
                    livenet: 'https://bch-insight.thoughtnetwork.com/#/tx/{{txid}}',
                    testnet: 'https://test-bch-insight.thoughtnetwork.com/#/tx/{{txid}}',
                  }
                },
              },
            }, function(err) {
      ...
      helpers.stubUtxos(server, wallet, [1, 1], function() {
        ...
        async.waterfall([
          ...
          setTimeout(function() {
            ...
            should.exist(one.html);
            one.html.should.contain('https://insight.thoughtnetwork.com/tx/' + txp.txid);
            server.storage.fetchUnsentEmails(function(err, unsent) {
              should.not.exist(err);
              unsent.should.be.empty;
              emailService._readTemplateFile = _readTemplateFile_old;
    ...
    it('should handle small incomming payments (tht)', function(done) {
        ...
        server.createAddress({}, function(err, address) {
          ...
          server._notify('NewIncomingTx', {
            ...
            setTimeout(function() {
              ...
              spanish.text.should.contain('0.123 THT');
