...
describe('Utils', function() {
  ...
  describe('#getAddressCoin', function() {
    it('should identify tht as coin for 1LqBGSKuX5yYUonjxT5qGfpUsXKYYWeabA', function() {
      Utils.getAddressCoin('1LqBGSKuX5yYUonjxT5qGfpUsXKYYWeabA').should.equal('tht');
    });
  ...
  describe('#parseAppVersion', function() {
    ...
    it('should parse version case 2', function() {
      Utils.parseAppVersion('thoughtnetwork 5.2.2 (Android 8.0.0 - SM-N950U)').should.deep.equal({
        app: 'thoughtnetwork',
        major: 5,
        minor: 2,
        patch: 2,
    ...
    it('should parse version case 3', function() {
      Utils.parseAppVersion('thoughtnetwork 5.2.2 (iOS 12.0 - iPhone9,2)').should.deep.equal({
        app: 'thoughtnetwork',
        major: 5,
        minor: 2,
        patch: 2,
  ...
  describe('#translateAddress', function() {
    it('should translate address from tht to bch', function() {
      var res = Utils.translateAddress('1LqBGSKuX5yYUonjxT5qGfpUsXKYYWeabA', 'bch');
      res.should.equal('CcJ4qUfyQ8x5NwhAeCQkrBSWVeXxXghcNz');
    });
    it('should translate address from bch to tht', function() {
      var res = Utils.translateAddress('HBf8isgS8EXG1r3X6GP89FmooUmiJ42wHS', 'tht');
    ...
    it('should keep the address if there is nothing to do (tht)', function() {
      var res = Utils.translateAddress('1LqBGSKuX5yYUonjxT5qGfpUsXKYYWeabA', 'tht');
      should.exist(res);
