...
describe('payproV2', () => {
  ...
  describe('_asyncRequest', () => {
    ...
    it('Should handle a failed (404) request', (done) => {
        ...
        'post': (_url) => {
          return {
            ...
            agent: (_opts) => { },
              ...
              return cb('error', {
                headers: TestData.payProJsonV2.tht.headers,
                statusCode: 404,
      ...
      payProV2._asyncRequest({
        url: 'https://thoughtnetwork.com/i/LanynqCPoL2JQb8z8s5Z3X',
        method: 'post',
        headers: {
    ...
    it('should return rawBody and headers', (done) => {
      mockRequest(Buffer.from(TestData.payProJson.tht.body, 'hex'), TestData.payProJson.tht.headers);
      payProV2._asyncRequest({
        url: 'https://thoughtnetwork.com/i/LanynqCPoL2JQb8z8s5Z3X',
        method: 'post',
        headers: {
  ...
  describe('getPaymentOptions', () => {
    ...
    it('should fail if the protocol is invalid', (done) => {
      mockRequest(Buffer.from(TestData.payProJsonV2.tht.body, 'hex'), TestData.payProJsonV2.tht.headers);
      var opts = {
        paymentUrl: 'thoughtnetwork.com/i/LanynqCPoL2JQb8z8s5Z3X'
      };
      payProV2.getPaymentOptions(opts).then((res) => {
        res.should.not.exist;
      }).catch(err => {
