...
var Thoughtcore = require('crypto-wallet-core').ThoughtcoreLib;
...
describe('Utils', () => {
  ...
  describe('#xPubToCopayerId', () => {
    it('should generate copayerId THT', () => {
      var xpub = Thoughtcore.HDPublicKey.fromString('xpub6BosfCnifzxcFwrSzQiqu2DBVTshkCXacvNsWGYJVVhhawA7d4R5WSWGFNbi8Aw6ZRc1brxMyWMzG3DSSSSoekkudhUd9yLb6qx39T9nMdj');
      var res = Utils.xPubToCopayerId('tht', xpub);
  ...
  describe('#privateKeyToAESKey', () => {
    it('should be ok', () => {
      var privKey = new Thoughtcore.PrivateKey('09458c090a69a38368975fb68115df2f4b0ab7d1bc463fc60c67aa1730641d6c').toString();
  ...
  describe('#verifyRequestPubKey', () => {
    it('should generate and check request pub key', () => {
      var reqPubKey = (new Thoughtcore.PrivateKey).toPublicKey();
      var xPrivKey = new Thoughtcore.HDPrivateKey();
      var xPubKey = new Thoughtcore.HDPublicKey(xPrivKey);
    ...
    it('should fail to check a request pub key with wrong key', () => {
      ...
      var xPrivKey2 = new Thoughtcore.HDPrivateKey();
      var xPubKey2 = new Thoughtcore.HDPublicKey(xPrivKey2);
