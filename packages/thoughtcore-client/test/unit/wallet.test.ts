...
describe('Wallet', function() {
  ...
  for (const chain of ['THT', 'BCH', 'LTC', 'DOGE', 'ETH', 'XRP', 'MATIC']) {
    for (const addressType of Object.keys(AddressTypes[chain] || { 'pubkeyhash': 1 })) {
      ...
      it(`should create a wallet for chain and addressType: ${chain} ${addressType}`, async function() {
        walletName = 'ThoughtcoreClientTest' + chain + addressType;
  ...
  describe('bumpTxFee', function() {
    describe('UTXO', function() {
      walletName = 'ThoughtcoreClientTestBumpFee-UTXO';
      ...
      it('should bump the fee of a transaction with feeTarget', async function() {
        sandbox.stub(wallet, 'getTransactionByTxid').resolves({"_id":"65982807d85e75f781a0d56f","txid":"8b78e4d2ac2211472454f940445210b6487aaa0f889e18066eb3f623352607f5","network":"regtest","chain":"THT","blockHeight":-1,"blockHash":"","blockTime":"2024-01-05T16:02:15.678Z","blockTimeNormalized":"2024-01-05T16:02:15.678Z","coinbase":false,"locktime":-1,"inputCount":5,"outputCount":1,"size":780,"fee":2409,"value":950891,"confirmations":0,"coins":{"inputs":[{"_id":"659825bed85e75f781a01812","chain":"THT","network":"regtest","coinbase":false,"mintIndex":1,"spentTxid":"8b78e4d2ac2211472454f940445210b6487aaa0f889e18066eb3f623352607f5","mintTxid":"330716a75c23512202e45ffee478bdce7a33f298edf7eef30a42dbde06746c48","mintHeight":154,"spentHeight":-1,"address":"n2vpyzbBPBEni9FgkeQSnXvAQAfnRmKxFZ","script":"76a914eade85745090388e64a9341a82d8f94371430d1a88ac","value":244000,"confirmations":-1,"sequenceNumber":4294967293},{"_id":"65982587d85e75f781a0046f","chain":"THT","network":"regtest","coinbase":false,"mintIndex":1,"spentTxid":"8b78e4d2ac2211472454f940445210b6487aaa0f889e18066eb3f623352607f5","mintTxid":"7b83f82a22f94fc3e615743a5e6fb2345ed79aad8a2b564af2ace49da1e27ebb","mintHeight":152,"spentHeight":-1,"address":"muEU9KaNEw5doymy59ScrgEE3Eq4CQ45U9","script":"76a91496739b4ef4e793c05a78624da38d96f2c4059c6b88ac","value":239400,"confirmations":-1,"sequenceNumber":4294967293},{"_id":"65982511d85e75f7819fdd40","chain":"THT","network":"regtest","coinbase":false,"mintIndex":0,"spentTxid":"8b78e4d2ac2211472454f940445210b6487aaa0f889e18066eb3f623352607f5","mintTxid":"fb4d8039024c80a655fea29e01faf202f30e936af5738e31c5841a84215ca4d6","mintHeight":149,"spentHeight":-1,"address":"muEU9KaNEw5doymy59ScrgEE3Eq4CQ45U9","script":"76a91496739b4ef4e793c05a78624da38d96f2c4059c6b88ac","value":239400,"confirmations":-1,"sequenceNumber":4294967293},{"_id":"659824d7d85e75f7819fc75d","chain":"THT","network":"regtest","coinbase":false,"mintIndex":0,"spentTxid":"8b78e4d2ac2211472454f940445210b6487aaa0f889e18066eb3f623352607f5","mintTxid":"8221ed6891f6ba82ab72bb8298a661e21b47b04408861b0c3268c4a04a0435b3","mintHeight":145,"spentHeight":-1,"address":"miEzS8fSvtDjwkEjY14FEuWumFKg8nTPV9","script":"76a9141de381fc20d34d20e11a5543f536a4b74f495a9888ac","value":228000,"confirmations":-1,"sequenceNumber":4294967293},{"_id":"65982389d85e75f7819f57ff","chain":"THT","network":"regtest","coinbase":false,"mintIndex":0,"spentTxid":"8b78e4d2ac2211472454f940445210b6487aaa0f889e18066eb3f623352607f5","mintTxid":"95f713c2d7e09ab57ec3016bb767b26e6ee849cf487e86d8ed6126ae1b893e0f","mintHeight":143,"spentHeight":-1,"address":"msnM9VB5usfBahZNo57ZUq9uzwRxQXksUz","script":"76a914868ad3308906626182d1c6cd703cc7ce78b3a28d88ac","value":2500,"confirmations":-1,"sequenceNumber":4294967293}],"outputs":[{"_id":"65982807d85e75f781a0d55d","chain":"THT","network":"regtest","coinbase":false,"mintIndex":0,"spentTxid":"","mintTxid":"8b78e4d2ac2211472454f940445210b6487aaa0f889e18066eb3f623352607f5","mintHeight":-1,"spentHeight":-2,"address":"mwwrGzk9q8xugY97C8BiNbcgqXNyjH4kp8","script":"76a914b4376347e4cffb1e9a475b2661bbe74de3c1f86a88ac","value":950891,"confirmations":-1}]}})
        ...
        sandbox.spy(CWC.ThoughtcoreLib.Transaction.prototype, 'feePerByte');
        ...
        CWC.ThoughtcoreLib.Transaction.prototype.feePerByte.callCount.should.equal(1);
        CWC.ThoughtcoreLib.Transaction.prototype.feePerByte.args[0][0].should.equal(65);
      ...
      it('should bump the fee of a transaction with feeRate', async function() {
        ...
        CWC.ThoughtcoreLib.Transaction.prototype.feePerByte.callCount.should.equal(1);
        CWC.ThoughtcoreLib.Transaction.prototype.feePerByte.args[0][0].should.equal(2);
    ...
    describe('EVM', function() {
      walletName = 'ThoughtcoreClientTestBumpFee-EVM';
  ...
  describe('getLocalAddress', function() {
    for (const storageType of ['Level', 'Mongo', 'TextFile']) {
      describe(storageType, function() {
        let wallet;
        let walletName = 'ThoughtcoreClientTestGetLocalAddress' + storageType;
        ...
        if (storageType === 'Mongo' && (process.env.DB_NAME || process.env.DB_HOST || process.env.DB_PORT)) {
          path = `mongodb://${process.env.DB_HOST || 'localhost'}:${process.env.DB_PORT || 27017}/${process.env.DB_NAME || 'thoughtcoreWallets-test'}`;
        }
  ...
  describe('importKeys', function() {
    walletName = 'ThoughtcoreClientTestImportKeys';
    let requestStub;
    let sleepStub;
    ...
    it('should import 1 key', async function() {
      ...
      for (let i = 0; i < 1; i++) {
        ...
        keys.push({
          privKey: pk,
          address: libMap.THT.PrivateKey(pk).toAddress().toString()
        });
      }
