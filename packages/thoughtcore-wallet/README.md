...
[![NPM Package](https://img.shields.io/npm/v/thoughtcore-wallet.svg?style=flat-square)](https://www.npmjs.org/package/thoughtcore-wallet)

**A simple Command Line Interface Wallet using [Thoughtcore Wallet Service](https://github.com/thoughtnetwork/thoughtcore/tree/master/packages/thoughtcore-wallet-service) and its *official* client lib [Thoughtcore Wallet Client](https://github.com/thoughtnetwork/thoughtcore/tree/master/packages/thoughtcore-wallet-client).**

This can be used to operate Thought and Thought Cash wallets.
...
# git clone https://github.com/thoughtnetwork/thoughtcore/tree/master/packages/thoughtcore-wallet-service.git bws
...
# Spend coins. Amount can be specified in tht, bit or sat (default)
...
# You can use 1000bit or 0.0001tht or 100000sat. (Set BIT_UNIT to tht/sat/bit to select output unit).

It is also possible to use Payment Protocol or BIP21. Examples:

wallet send 'thought:?r=https://thoughtnetwork.com/i/8rR7ydnLfQGqnRW1mqvXxJ'
wallet send 'thought:1N4zjmp1ojRborDiAu62MyCpaz9wjhPLM?amount=1'
