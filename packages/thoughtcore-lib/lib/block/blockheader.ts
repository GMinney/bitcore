...
export default class BlockHeader {
   ...
   */
  getTargetDifficulty = function getTargetDifficulty(bits) {
    bits = bits || this.bits;
  ...
  /**
   * @link https://en.thought.it/wiki/Difficulty
   * @return {Number}
   */
   ...
   */
  validTimestamp = function validTimestamp() {
   ...
   */
  validProofOfWork = function validProofOfWork() {
