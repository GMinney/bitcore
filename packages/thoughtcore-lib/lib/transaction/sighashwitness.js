 ...
 * @param {Buffer} notionsBuffer
 */
var sighash = function sighash(transaction, sighashType, inputNumber, scriptCode, notionsBuffer) {
 ...
 * @return {Signature}
 */
function sign(transaction, privateKey, sighashType, inputIndex, scriptCode, notionsBuffer) {
  let hashbuf = sighash(transaction, sighashType, inputIndex, scriptCode, notionsBuffer);
 ...
 * @return {boolean}
 */
function verify(transaction, signature, publicKey, inputIndex, scriptCode, notionsBuffer) {
  ...
  let hashbuf = sighash(transaction, signature.nhashtype, inputIndex, scriptCode, notionsBuffer);
