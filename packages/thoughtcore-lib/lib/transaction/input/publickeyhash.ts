...
export class PublicKeyHashInput extends Input {
  ...
  static SCRIPT_MAX_SIZE = 73 + 34; // sigsize (1 + 72) + pubkey (1 + 33)
  static REDEEM_SCRIPT_SIZE = 1 + 22; // len (1) OP_0 (1) pubkeyhash (1 + 20)
  ...
  getRedeemScript = function (publicKey) {
  ...
  getScriptCode = function (publicKey) {
