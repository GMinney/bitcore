...
import PubKeyHashInput from "./publickeyhash.js";
...
export class TaprootInput extends PubKeyHashInput {
  constructor() {
    super();
  ...
  isValidSignature = function (transaction, signature) {
   ...
   */
  addSignature = function (transaction, signature) {
