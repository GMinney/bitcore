...
Message.MAGIC_BYTES = Buffer.from('Thought Signed Message:\n');
 ...
 * @returns {Boolean}
 */
Message.prototype.verify = function verify(thoughtAddress, signatureString) {
 ...
 * @returns {String}
 */
Message.prototype.recoverPublicKey = function recoverPublicKey(thoughtAddress, signatureString) {
  $.checkArgument(thoughtAddress);
  $.checkArgument(signatureString && _.isString(signatureString));
