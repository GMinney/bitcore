...
import TaggedHash from "./taggedhash.js";
...
export default class Schnorr {
   ...
   */
  static sign = function (privateKey, message, aux) {
   ...
   */
  static verify = function (publicKey, message, signature) {
...
export const getE = function (r, P, message) {
  const n = Point.getN();
