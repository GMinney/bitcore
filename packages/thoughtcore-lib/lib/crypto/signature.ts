...
export default class Signature {
  ...
  static SIGHASH_DEFAULT = 0x00; //!< Taproot only; implied when sighash byte is missing, and equivalent to SIGHASH_ALL
  ...
  static SIGHASH_INPUT_MASK = 128; // 0x80,
  ...
  static fromCompact = function (buf) {
  ...
  fromDER = fromBuffer = function (buf, strict) {
    var sig = new Signature();
  ...
  static fromTxFormat = function (buf) {
   ...
   */
  static parseDER = function (buf, strict) {
  ...
  /**
   * This function is translated from thoughtd's IsDERSignature and is used in
  ...
  /**
   * Compares to thoughtd's IsLowDERSignature
   ...
   * @returns {Signature}
   */
  static fromSchnorr = function (buf) {
