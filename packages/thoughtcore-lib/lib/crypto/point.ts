 ...
 * @constructor
 */
export default class Point extends ec.curve.point {
 ...
 * @returns {Point} An instance of Point
 */
static fromX = function fromX(odd, x) {
  try {
 ...
 *
 * @link https://en.thought.it/wiki/Secp256k1
 * @returns {Point} An instance of the base point.
 */
static getG = function getG() {
  return ec.curve.g;
};
 ...
 * (A.K.A curve order)
 * @link https://en.thought.it/wiki/Private_key#Range_of_valid_ECDSA_private_keys
 * @returns {BN} A BN instance of the number of points on the curve
 */
static getN = function getN() {
...
static pointToCompressed = function pointToCompressed(point) {
