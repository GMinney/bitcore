...
Represents a thought address. Addresses are the most popular way to make thought transactions. See [the official Thought Wiki](https://en.thought.it/wiki/Address) for technical background information.

## Instantiate an Address

To be able to receive thoughts, an address is needed, but in order to spend them a private key is necessary. Please take a look at the [`PrivateKey`](privatekey.md) docs for more information about exporting and saving a key.  
...
The errors are listed in the generated file in the [errors folder](https://github.com/thoughtnetwork/thoughtcore/tree/master/packages/thoughtcore-lib/lib/errors). There's a structure to errors defined in the [spec.js file](https://github.com/thoughtnetwork/thoughtcore/tree/master/packages/thoughtcore-lib/lib/errors/spec.js).
