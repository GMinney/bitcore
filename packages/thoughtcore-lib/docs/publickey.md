...
Represents a thought public key and is needed to be able to receive thought, as is usually represented as a thought [Address](address.md). See the official [Thought Wiki](https://en.thought.it/wiki/Technical_background_of_version_1_Thought_addresses).

A PublicKey in Thoughtcore is an immutable object and can be instantiated from a [Point](crypto.md), string, [PrivateKey](privatekey.md), Buffer or a [BN](crypto.md).
...
A public key point should be on the [secp256k1](https://en.thought.it/wiki/Secp256k1) curve, instantiating a new PublicKey will validate this and will throw an error if it's invalid. To check that a public key is valid:
...
> var compressedPK2 = new thoughtcore.PublicKey('02a1633cafcc01ebfb6d78e39f687a1f'+
...
> var uncompressed = thoughtcore.PublicKey('0479BE667EF9DCBBAC55A06295CE870B07029'+
