...
describe('URI', function () {
  ...
  it('parses uri strings correctly (test vector)', function () {
    ...
    uri = URI.parse('thought:1DP69gMMvSuYhbnxsi4EJEFufUAbDrEQfj');
  ...
  it('should generate a valid URI', function () {
    new URI({
      ...
      'thought:1DP69gMMvSuYhbnxsi4EJEFufUAbDrEQfj'
    );
    ...
    new URI({
      ...
      'thought:1DP69gMMvSuYhbnxsi4EJEFufUAbDrEQfj?amount=1.10001&message=Hello%20World&something=else'
    );
