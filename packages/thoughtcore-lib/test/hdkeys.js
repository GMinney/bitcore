...
var HDPrivateKey = thoughtcore.HDPrivateKey;
var HDPublicKey = thoughtcore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  it('should use full 32 bytes for private key data that is hashed (as per bip32)', function() {
    // https://github.com/thought/bips/blob/master/bip-0032.mediawiki
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = thoughtcore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(thoughtcore.crypto.BN.prototype, 'toBuffer').callsFake(function (args) {
      ...
      sandbox.spy(thoughtcore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      thoughtcore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = thoughtcore.PublicKey.fromPoint;
      thoughtcore.PublicKey.fromPoint = function() {
        thoughtcore.PublicKey.fromPoint = unstubbed;
...
//test vectors: https://github.com/thought/bips/blob/master/bip-0032.mediawiki
