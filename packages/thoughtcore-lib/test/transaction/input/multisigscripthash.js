...
var MultiSigScriptHashInput = thoughtcore.Transaction.Input.MultiSigScriptHash;
...
describe('MultiSigScriptHashInput', function () {
  ...
  it('will get the notions buffer for nested witness', function () {
    var address = Address.createMultisig([public1, public2, public3], 2, 'testnet', true);
    var utxo = {
      address: address.toString(),
      txId: '66e64ef8a3b384164b78453fa8c8194de9a473ba14f89485a0e433699daec140',
    ...
    var transaction = new Transaction()
      ...
      .to(address, 1000000);
    var input = transaction.inputs[0];
    var notionsBuffer = input.getNotionsBuffer();
    notionsBuffer.toString('hex').should.equal('40420f0000000000');
  });
