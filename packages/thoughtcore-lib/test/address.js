...
var Address = thoughtcore.Address;
var Script = thoughtcore.Script;
var Networks = thoughtcore.Networks;

var validbase58 = require('./data/thoughtd/base58_keys_valid.json');
var invalidbase58 = require('./data/thoughtd/base58_keys_invalid.json');
...
describe('Address', function() {
  ...
  describe('thoughtd compliance', function() {
  ...
  describe('encodings', function() {
    ...
    it('should error because of unrecognized data format', function() {
      ...
      }).should.throw(thoughtcore.errors.InvalidArgument);
    });
  ...
  describe('#object', function() {
    ...
    it('will fail with invalid state', function() {
      ...
      }).to.throw(thoughtcore.errors.InvalidState);
    });
  });
