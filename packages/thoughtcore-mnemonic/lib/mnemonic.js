...
const _ = thoughtcore.deps._;

const pbkdf2 = require('./pbkdf2');
const errors = require('./errors');

const Hash = thoughtcore.crypto.Hash;
const Random = thoughtcore.crypto.Random;

const $ = thoughtcore.util.preconditions;


/**
 * This is an immutable class that represents a BIP39 Mnemonic code.
 * See BIP39 specification for more info: https://github.com/thought/bips/blob/master/bip-0039.mediawiki
...
var Mnemonic = function(data, wordlist) {
  ...
  if (Buffer.isBuffer(data)) {
    ...
    throw new thoughtcore.errors.InvalidArgument('data', 'Must be a Buffer, a string or an integer');
  }
  ent = ent || 128;
  ...
  if (ent % 32 !== 0 || ent < 128 || ent > 256) {
    throw new thoughtcore.errors.InvalidArgument('ENT', 'Values must be ENT > 128 and ENT < 256 and ENT % 32 == 0');
  }
 ...
 * Optionally receive a passphrase and thought network.
 *
 * @param {String=} [passphrase]
...
Mnemonic.prototype.toHDPrivateKey = function(passphrase, network) {
  ...
  return thoughtcore.HDPrivateKey.fromSeed(seed, network);
};
...
Mnemonic.thoughtcore = thoughtcore;
