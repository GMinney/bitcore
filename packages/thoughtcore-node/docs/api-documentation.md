...
GET `/api/THT/mainnet/tx?blockHeight=12`
...
```sh
curl -v localhost:3000/api/THT/mainnet/tx?blockHeight=12
```
...
GET `/api/THT/mainnet/tx?blockHash=000000006a625f06636b8bb6ac7b960a8d03705d1ace08b1a19da3fdcc99ddbd`
...
```sh
curl -v localhost:3000/api/THT/mainnet/tx?blockHash=000000006a625f06636b8bb6ac7b960a8d03705d1ace08b1a19da3fdcc99ddbd
```
...
```sh
curl -v localhost:3000/api/THT/mainnet/tx/9b0fc92260312ce44e74ef369f5c66bbb85848f2eddd5a7a1cde251e54ccfdd5
```
...
GET `/THT/mainnet/tx/:txid/authhead`
...
```sh
curl -v localhost:3000/api/THT/mainnet/tx/3b96bb7e197ef276b85131afd4a09c059cc368133a26ca04ebffb0ab4f75c8b8/authhead
```
...
```sh
curl -v localhost:3000/api/THT/mainnet/tx/3b96bb7e197ef276b85131afd4a09c059cc368133a26ca04ebffb0ab4f75c8b8/coins
```
...
GET `/api/THT/mainnet/address/:address/txs`
...
```sh
curl -v localhost:3000/api/THT/mainnet/address/12c6DSiU4Rq3P4ZxziKxzrL5LmMBrzjrJX/txs
```
...
GET `/api/THT/mainnet/address/:address/?unspent=true`
...
```sh
curl -v localhost:3000/api/THT/mainnet/address/12c6DSiU4Rq3P4ZxziKxzrL5LmMBrzjrJX/?unspent=true
```
...
GET `/api/THT/mainnet/address/:address/balance`
...
```sh
curl -v localhost:3000/api/THT/mainnet/address/12c6DSiU4Rq3P4ZxziKxzrL5LmMBrzjrJX/balance
```
...
GET `/api/THT/mainnet/block/:blockId`
...
```sh
curl -v localhost:3000/api/THT/mainnet/block/00000000839a8e6886ab5951d76f411475428afc90947ee320161bbf18eb6048
```
...
```sh
curl -v localhost:3000/api/THT/mainnet/block/tip
```
...
**To test wallet api routes change allowUnauthenticatedCalls: true inside thoughtcore.config.json**
...
Inside the project root directory /thoughtcore/ run:

```sh
node packages/thoughtcore-node/build/test/benchmark/wallet-benchmark.js
```

### Add Wallet

POST `/api/THT/mainnet/wallet`
...
"http://localhost:3000/api/THT/mainnet/wallet/"
```
...
GET `/api/THT/mainnet/wallet/:pubKey`
...
```sh
curl -v localhost:3000/api/THT/mainnet/wallet/03bdb94afdc7e5c4811bf9b160ac475b82156ea42c8659c8358b68c828df9a1c3d
```
...
POST `/api/THT/mainnet/wallet/:pubKey`
...
GET `/api/THT/mainnet/wallet/:pubKey/addresses`
...
```sh
curl -v localhost:3000/api/THT/mainnet/wallet/03bdb94afdc7e5c4811bf9b160ac475b82156ea42c8659c8358b68c828df9a1c3d/addresses
```
...
GET `/api/THT/mainnet/wallet/:pubKey/transactions`
...
```sh
curl -v localhost:3000/api/THT/mainnet/wallet/02870d8366cf8e50f383e38e5fafc01d956b67f25fbf5c1dd4e3766cf85acbc400/transactions
```
...
GET `/api/THT/mainnet/wallet/:pubKey/balance`
...
```sh
curl -v localhost:3000/api/THT/mainnet/wallet/02870d8366cf8e50f383e38e5fafc01d956b67f25fbf5c1dd4e3766cf85acbc400/balance
```
...
GET `/api/THT/mainnet/wallet/:pubKey/utxos`
...
```sh
curl -v localhost:3000/api/THT/mainnet/wallet/02870d8366cf8e50f383e38e5fafc01d956b67f25fbf5c1dd4e3766cf85acbc400/utxos
```
...
```sh
curl -v localhost:3000/api/THT/mainnet/wallet/02870d8366cf8e50f383e38e5fafc01d956b67f25fbf5c1dd4e3766cf85acbc400/addresses/missing
```
...
GET `/api/THT/mainnet/fee/:target`
...
```sh
curl -v localhost:3000/api/THT/mainnet/fee/22
```
...
GET `/api/THT/mainnet/stats/daily-transactions`
...
```sh
curl -v localhost:3000/api/THT/mainnet/stats/daily-transactions
```
